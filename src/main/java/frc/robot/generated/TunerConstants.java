...
public class TunerConstants {
  ...
  private static final Slot0Configs driveGains =
      new Slot0Configs()
          ...
          .withKI(0)
          .withKD(0)
          .withKS(0.15113883013573412)
          .withKV(0.821374744252407);
  ...
  private static final Pigeon2Configuration pigeonConfigs =
      new Pigeon2Configuration().withMountPose(new MountPoseConfigs().withMountPoseYaw(0));

  // CAN bus that the devices are located on;
  // All swerve devices must share the same CAN bus
  public static final CANBus kCANBus =
      new CANBus(Constants.CANBus.DRIVETRAIN_CANBUS, "./logs/example.hoot");
  ...
  // btw maybe set steerinertia to 0.004 and driveinertia to 0.025 if things dont work
  // but it should work fine, since it was this way in 2025 code
  ...
  private static final Angle kBackRightEncoderOffset = Rotations.of(-0.49462890625);
