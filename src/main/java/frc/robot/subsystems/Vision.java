...
public class Vision extends SubsystemBase {
  ...
  public void enableTargetTagFilter() {
    LimelightHelpers.SetFiducialIDFiltersOverride(
        Constants.VisionConstants.LIMELIGHT_Four_One, new int[] {getTargetTagID()});
  }
  ...
  public void disableTargetTagFilter() {
    LimelightHelpers.SetFiducialIDFiltersOverride(
        Constants.VisionConstants.LIMELIGHT_Four_One, Constants.VisionConstants.ALL_TAG_IDS);
  }
  ...
  public boolean hasTarget() {
    if (!LimelightHelpers.getTV(Constants.VisionConstants.LIMELIGHT_Four_One)) return false;
    int trackedID =
        (int) LimelightHelpers.getFiducialID(Constants.VisionConstants.LIMELIGHT_Four_One);
   ...
   */
  public double getTX() {
    return LimelightHelpers.getTX(Constants.VisionConstants.LIMELIGHT_Four_One);
  }
   ...
   */
  public double getTY() {
    return LimelightHelpers.getTY(Constants.VisionConstants.LIMELIGHT_Four_One);
  }
  ...
  public int getTrackedTagID() {
    return (int) LimelightHelpers.getFiducialID(Constants.VisionConstants.LIMELIGHT_Four_One);
  }
